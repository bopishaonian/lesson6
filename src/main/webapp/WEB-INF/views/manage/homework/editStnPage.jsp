...
<lesson:page title="修改学生">
	<jsp:attribute name="script">
		<script type="text/javascript">
            document.addEventListener("DOMContentLoaded",function(){
                var va = $("#checkRadio").val();
                var v = $("#checkSelect").val();
                var vs =  $("#checkS").find("option");
                var p = $("#pdate").text();
				if(va=="男"){
				...
				for(var i = 0;i<vs.length;i++){
					...
					if(v==$(vs[i]).val()){
                        $(vs[i]).attr("selected", "selected");
					}
				}
                $("#id-date-picker-1").val(p);
            });
            jQuery(function($) {
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								...
								<form id="form" class="form-horizontal" role="form" action="manage/student/edit.do?studentId=${stn.studentId}" enctype="multipart/form-data" method="post">
									<!--头像-->
									<div class="form-group">
										...
										<div class="col-sm-9">
											<img height="150" width="110" class="thumbnail inline no-margin-bottom" alt="Domain Owner's Avatar"
												 src="https://huangbo-oss.oss-cn-shenzhen.aliyuncs.com/${stn.img}" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="num" id="form-field-1"
												   placeholder="请输入不重复的学号！"
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="name" placeholder="请输入学生姓名！"
												   class="col-xs-10 col-sm-5" value="${stn.name}"/>
										</div>
									</div>
									<!--班级-->
									<div class="form-group" >
										...
										<div class="col-sm-9">
											...
											<input type="hidden" id="checkSelect" value="${stn.gradeId}">
											<select class="col-xs-10 col-sm-5" name="gradeId" id="checkS" style="width: 388px">
									...
									<div class="form-group">
										...
										<div class="radio">
											<input type="hidden" id="checkRadio" value="${stn.sex}">
											<label>
									...
									<!--出生日期-->
									<p hidden id="pdate"><fmt:formatDate value="${stn.date}"
									...
									<div class="form-group">
										...
										<div class="col-sm-9" style="width: 500px">
											<input class="form-control date-picker" name="stn_birthdayStr" id="id-date-picker-1"
