					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								...
								<form id="form" class="form-horizontal" role="form" action="manage/student/addStn.do" enctype="multipart/form-data" method="post">
									<!--头像-->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="num" id="form-field-1" placeholder="请输入不重复的学号！" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<!--姓名-->
									<div class="form-group">
									...
									<div class="form-group" >
										...
										<div class="col-sm-9">
											<select class="col-xs-10 col-sm-5" name="gradeId" style="width: 388px">
									...
									<div class="form-group">
										...
										<div class="col-sm-9" style="width: 500px">
											<input class="form-control date-picker" name="stn_birthdayStr" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" />
										</div>
									</div>
									<script>
                                        jQuery(function($) {
